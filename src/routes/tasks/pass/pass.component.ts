...
@Component({
  selector: 'cadrart-route-tasks-pass',
...
export class CadrartRouteTasksPassComponent extends CadrartRouteTasksBaseComponent {
  protected family = ECadrartArticleFamily.PASS;
